...
class HD_model():
    def __init__(self, classes = 20, d = 1000, num_features=766, lr = 0.01, **kwargs):
        self.d = d
        self.div = kwargs['div']
...
class EPCLOutdoorSegHD(BaseSegmentor):    
    ...
    def forward(self, batch_dict, return_logit=False, return_tta=False, train_hd=False):
        ...
        if train_hd:
            ...
            self.hd_model.train(concat_feat, batch_dict['targets'].feats)
            ...
            point_predict = []
            point_labels = []
            hv, sim, pred_label = self.hd_model.forward(concat_feat.F)
